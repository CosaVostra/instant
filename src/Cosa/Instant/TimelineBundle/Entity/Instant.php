...
class Instant
{
    ...
    /**
     * @ORM\Column(type="string", length=255, nullable=true, options={"default":"Dear @EXPERT, @JOURNALIST designated you as an expert @WVIEW"})
     */
    private $message_type = "Dear @EXPERT, @JOURNALIST designated you as an expert @WVIEW";
